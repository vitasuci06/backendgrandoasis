...
if (isset($_SESSION['user_id'])){
    ...
    $userQuery = "SELECT * FROM admin WHERE Admin_id = '$user_id'";
...
elseif (isset($_GET['reservasi_meeting'])){
    include_once "reservasi_meeting.php";
}
elseif (isset($_GET['reservasi_ballroom'])){
    include_once "reservasi_ballroom.php";
}

    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.done == true) {
                ...
                $('#Tipe_kamar').html(response.Tipe_kamar);
                $('#Nomor_kamar').html(response.Nomor_kamar);
                $('#CheckInDate').html(response.CheckInDate);
                $('#CheckOutDate').html(response.CheckOutDate);
                $('#Status').html(response.Status);
                $('#Harga').html(response.Harga);
                $('#Tanggal_bayar').html(response.Tanggal_bayar);
                $('#Jumlah_bayar').html(response.Jumlah_bayar);
                $('#Metode_bayar').html(response.Metode_bayar);   
